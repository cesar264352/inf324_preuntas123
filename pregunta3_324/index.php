...
<head>
	...
	<title>Pregunta 3 | Examen 324</title>
		...
		<table class="table-fill">
			<thead>
				<tr>
					...
					<th class="text-left">Notas por Dpto.</th>
			...
			<tbody class="table-hover">
				<?php 
					...
					$sql = "SELECT ci,paterno,materno,nombre,usuario FROM persona INNER JOIN usuario ON persona.ci=usuario.id_persona INNER JOIN rol ON usuario.rol_fk=rol.id_rol WHERE rol.id_rol=1";
